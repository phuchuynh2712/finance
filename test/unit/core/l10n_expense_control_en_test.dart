...
void main() {
  testWidgets('English ARB strings resolve for Expense Control (no raw keys)', (tester) async {
    ...
    expect(l10n.expenseControlEmptyStateMessage, isNot(contains('expenseControl')));
